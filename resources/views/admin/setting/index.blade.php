                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <textarea type="text" name="meta_keyword" class="form-control" rows="3">value="{{ $setting->meta_keyword ?? '' }}"</textarea>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="">Meta Description</label>
                                <textarea type="text" name="meta_description" class="form-control" rows="3">value="{{ $setting->meta_description ?? '' }}"</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea type="text" name="address" class="form-control" rows="3">value="{{ $setting->address ?? '' }}"</textarea>
                            </div>
                            <div class="col-md-6 mb-3">
