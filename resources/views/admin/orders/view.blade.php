    ...
    <div class="col-md-12">
        ...
        <div class="card">
            <div class="card-header fw-bold">
                <h3>Customer Order Details
                <a href="{{ url('admin/orders') }}" class="btn btn-sm btn-danger float-end mx-1">Back</a>
                <a href="{{ url('admin/invoice/'.$order->id.'/generate') }}" class="btn btn-sm btn-primary float-end mx-1">Download Invoice</a>
                <a href="{{ url('admin/invoice/'.$order->id) }}" target="_blank" class="btn btn-warning btn-sm float-end mx-1 text-dark">View Invoice</a>
                </h3>
            </div>
            <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($order->orderItems as $orderItem)
                                        <tr>
                                            ...
                                            <td width="15%" class="fw-bold">{{ number_format($orderItem->price * $orderItem->quantity, 0, '.', ',') }}</td>
                                            @php
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="1" class="fw-bold">{{ number_format($totalPrice, 0, '.', ',') }} VND</td>
                                    </tr>
                                </tbody>
                            </table>
                ...
                <div class="row">
                    <div class="col-md-5">
                        <form action="{{ url('admin/orders/'.$order->id) }}" method="POST">
                            ...
                            <label for="">Update Order Status</label><br><br>
