            ...
            <div class="row">
                <div class="col-md-5 mt-3">
                    <div class="bg-white border">
                        ...
                        @if ($product->productImages)
                            <img src="{{ asset($product->productImages[0]->image) }}" class="w-100" style="height: wrap-content" alt="Img">
                        @else
                            No Image Added
                        @endif
                    </div>
                ...
                <div class="col-md-7 mt-3">
                    <div class="product-view">
                        ...
                        <div>
                            <span class="selling-price">{{ number_format($product->selling_price, 0, '.', ',') }} VND</span>
